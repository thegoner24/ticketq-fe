...
import { FaUser, FaLock, FaTicketAlt, FaEnvelope } from 'react-icons/fa';
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black border border-gray-800 rounded-lg overflow-hidden shadow-lg shadow-red-900/20">
          <div className="px-4 py-6 md:px-6 md:py-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <label htmlFor="confirmPassword" className="block text-xs md:text-sm font-medium text-gray-300 mb-1">
